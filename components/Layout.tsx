    ...
    <>
      ...
      <footer className="footer" role="contentinfo">
        <div className="footer-inner">
          ...
          <p>
            막내 직통 <a href="https://theassetsquare.com/"></a>
          </p>
          <p className="footer-copy">© 2026 대전원나이트 · 본 사이트는 업소의 공식 안내 페이지입니다</p>
        </div>
      </footer>
      <a href="https://theassetsquare.com/" className="float-call" aria-label="막내 직통 전화 ">
        <span className="float-call-icon" aria-hidden="true">
          📞
        </span>
        <span className="float-call-text">막내 직통 </span>
      </a>
    </>
  );
}
