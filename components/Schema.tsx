...
const FAQ_ITEMS = [
  ...
  { q: '예약은 어떻게 하나요?', a: '전화 예약을 권장합니다. 예약·문의는 페이지 하단 예약문의 전화로 안내드립니다.' },
  { q: '위치는 어디인가요?', a: '대전광역시 시내에 위치합니다. 정확한 위치는 예약 시 전화로 안내드립니다.' },
  ...
  { q: '문의 채널은?', a: '전화로 안내드립니다. 예약·문의는 페이지 하단 예약문의 전화를 이용해 주세요.' },
];
  ...
  const howto = includeHowTo
    ? {
        ...
        step: [
          ...
          { '@type': 'HowToStep', text: '전화로 좌석·룸 예약' },
