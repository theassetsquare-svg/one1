...
const FAQ_ITEMS = [
  ...
  { q: '예약은 어떻게 하나요?', a: '카카오톡 문의를 권장합니다. 문의는 페이지 하단 광고문의 카톡 besta12로 안내드립니다.' },
  { q: '위치는 어디인가요?', a: '대전광역시 시내에 위치합니다. 정확한 위치는 예약 시 카톡 besta12로 안내드립니다.' },
  { q: '드레스코드가 있나요?', a: '깔끔한 캐주얼 복장을 권장합니다. 슬리퍼, 반바지는 제한될 수 있습니다.' },
  { q: '주차는 가능한가요?', a: '주변 공영주차장 이용을 권장합니다.' },
  { q: '카드 결제가 되나요?', a: '네, 카드 결제 가능합니다.' },
  { q: '룸 예약이 가능한가요?', a: '예약 가능합니다. 카톡 besta12로 문의해 주세요.' },
  ...
  const howto = includeHowTo
    ? {
        ...
        step: [
          ...
          { '@type': 'HowToStep', text: '카톡 besta12로 좌석·룸 예약' },
