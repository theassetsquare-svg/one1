...
const FAQ_ITEMS = [
  ...
  { q: '예약은 어떻게 하나요?', a: '막내 직통  전화로 예약을 권장합니다. 막내가 직접 응대합니다.' },
  { q: '위치는 어디인가요?', a: '대전광역시 시내에 위치합니다. 정확한 위치는 막내 직통 로 안내드립니다.' },
  ...
  { q: '문의 채널은?', a: '막내 직통  전화로 막내가 직접 안내드립니다.' },
];
