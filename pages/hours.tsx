...
export default function Hours() {
  return (
    <>
      <SEO
        title="영업 시간 - 대전원나이트 (평일 20:00-02:30 / 주말 20:00-03:30)"
        description="대전원나이트 영업 시간 안내. 평일 20:00-02:30 / 주말 20:00-03:30. 38세 이상 입장. 예약 010-8677-1258."
        path="/hours"
        ...
        <div className="container">
          ...
          <section className="section">
            ...
            <p style={{ color: '#7a82a8', fontSize: '0.92rem', marginTop: 24 }}>
              ※ 공휴일·연휴 영업 시간은 변경될 수 있습니다. 방문 전 직통 010-8677-1258로 확인해 주세요.
            </p>
          </section>
