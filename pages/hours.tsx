  ...
  return (
    <>
      <SEO
        ...
        description="대전원나이트 영업 시간 안내. 평일 20:00 - 02:30, 주말 20:00 - 03:30. 22시 이전 입장 여성 손님 혜택 시간대까지 한눈에. 예약·문의는 페이지 하단 예약문의 전화로 안내드립니다."
        path="/hours"
        ...
        <div className="container">
          ...
          <section className="section">
            ...
            <p style={{ color: '#7a82a8', fontSize: '0.92rem', marginTop: 24 }}>
              ※ 공휴일·연휴 영업 시간은 변경될 수 있습니다. 방문 전 페이지 하단 예약문의 전화로 확인해 주세요.
            </p>
          </section>
