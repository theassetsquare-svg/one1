  ...
  return (
    <>
      <SEO
        ...
        description="불광동호박나이트 예약문의 안내. 서울 은평구 불광동 불광역 인근 나이트클럽 부킹·룸·단체 예약, 입장·복장·주차 정보를 한 페이지에 정리했습니다. 1937."
        path={PATH}
        ogImage="/og/hobak.png"
        ogAlt="광고 · 불광동호박나이트 · 손흥민 · 010-2221-1937"
        geoRegion="KR-11"
      ...
      <Layout callBar="phone" brand="hobak">
        <div className="hero">
          ...
          <Thumb src="/og/hobak.png" alt="광고 · 불광동호박나이트 · 손흥민 · 010-2221-1937" />
