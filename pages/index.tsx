...
const DESC =
  '서른아홉에 통장 잔액 11,200원을 보고 주저앉았던 사람이 1,146일 만에 빚을 다 갚기까지. 바닥에서 다시 일어선 과정을 숫자와 장면 그대로 옮긴 글입니다.';
    ...
    <>
      ...
      <footer style={{ maxWidth: 760, margin: '0 auto', padding: '26px 20px 40px', borderTop: '1px solid #e5e7eb', fontSize: '.9rem', lineHeight: 1.8, color: '#6b7280' }}>
        <nav aria-label="사이트 안내">
          <a href="/area/first-visit-area/" style={{ color: '#1f5f8b', textDecoration: 'underline' }}>처음 가는 동네 안내</a>
        </nav>
      </footer>
      {/* /area-guide-link */}
