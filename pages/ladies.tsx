  ...
  return (
    <>
      <SEO
        ...
        description="대전원나이트 여성 손님 안내. 22시 이전 입장 시 교통비 3만원 지원과 맥주 1병 기본 제공. 38세 이상 신분증 확인 후 적용. 예약·문의는 페이지 하단 예약문의 전화로 안내드립니다."
        path="/ladies"
        ...
        <div className="container">
          ...
          <section className="section">
            ...
            <p style={{ marginTop: 24 }}>
              자세한 안내는 페이지 하단 예약문의 전화로 문의해 주세요. 직접 응대해 드립니다.
            </p>
          </section>
        </div>
      </Layout>
