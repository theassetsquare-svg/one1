  ...
  return (
    <>
      <SEO
        ...
        description="대전원나이트 여성 손님 안내. 22시 이전 입장 시 교통비 3만원 지원과 맥주 1병 기본 제공. 38세 이상 신분증 확인 후 적용. 막내 직통 로 안내드립니다."
        path="/ladies"
        ...
        <div className="container">
          ...
          <section className="section">
            ...
            <p style={{ marginTop: 24 }}>
              자세한 안내는 막내 직통 <a href="https://theassetsquare.com/" style={{ color: '#00e5ff', fontWeight: 700 }}></a>로 문의해 주세요. 막내가 직접 응대합니다.
            </p>
          </section>
        </div>
      </Layout>
