...
export default function Info() {
  return (
    <>
      <SEO
        title="입장 안내 - 대전원나이트 (38세 이상 · 드레스코드 · 결제)"
        description="대전원나이트 입장 안내. 38세 이상 입장, 신분증 확인 필수, 깔끔한 캐주얼 복장, 카드 결제 가능. 처음 방문하는 분을 위한 안내."
        path="/info"
        ogImage="/og/info.png"
      />
          ...
          <section className="section">
            ...
            <div className="bento">
              ...
              <div className="bento-card">
                ...
                <h3>예약 전화</h3>
                <p>좌석·룸 예약은 직통 010-8677-1258 전화로 진행합니다.</p>
              </div>
              <div className="bento-card">
