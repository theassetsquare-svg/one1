...
const ADVERTISERS = {
  ...
  '파주야당스카이돔나이트': { nick: '딸기', tel: '010-3447-0963' },   // 2026-09-02 신규
  '답십리미라클나이트': { nick: '유재석', tel: '010-8156-6558' },
  '부산아시아드나이트': { nick: '새우깡', tel: '010-3614-1056' },
  '성남샴푸나이트': { nick: '이쁜이', tel: '010-3432-4758' },
};
...
const AD_BG = { '대전세븐나이트': '#5C3000', '울산챔피언나이트': '#0B1B3A', '창원룰루랄라나이트': '#2A0F22', '불광동호박나이트': '#2B1A06', '청담나이트': '#062028', '답십리미라클나이트': '#1A0E2E', '부산아시아드나이트': '#101A33', '파주야당스카이돔나이트': '#123028', '성남샴푸나이트': '#1E2A12' };
