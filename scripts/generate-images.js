...
<text x="540" y="955" font-family="Noto Sans KR" font-size="72" font-weight="900" fill="#0A0E27" text-anchor="middle" letter-spacing="-2"></text>
</svg>`;
...
<text x="600" y="555" font-family="Noto Sans KR" font-size="44" font-weight="900" fill="#00E5FF" text-anchor="middle" letter-spacing="-1"></text>
</svg>`;
...
const pages = [
  ...
  { name: 'contact', kicker: 'CONTACT', title: '막내 직통 ', sub: '예약·룸·단체 모두 막내가 응대' },
];
...
<text x="600" y="525" font-family="Noto Sans KR" font-size="34" font-weight="900" fill="#00E5FF" text-anchor="middle">막내 직통 </text>
</svg>`;
