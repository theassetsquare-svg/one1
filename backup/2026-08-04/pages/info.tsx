  ...
  return (
    <>
      <SEO
        ...
        description="대전원나이트 첫 방문이 처음이라면. 신분증·드레스코드·시간대·결제·주차까지 까치가 직접 알려주는 입장 가이드. 직통 010-3918-9414로 한 번에 확인하세요."
        path="/info"
        ogImage="/og/info.png"
      />
          ...
          <section className="section">
            ...
            <div className="bento">
              ...
              <div className="bento-card">
                ...
                <h3>까치에게 예약 전화</h3>
                <p>좌석·룸 예약은 까치 직통 010-3918-9414로 진행합니다. 까치가 직접 응대합니다.</p>
              </div>
              <div className="bento-card">
